...
const GroupLabels = {
  ...
  [GroupType.CHECKBOX]: 'Multiple Selection',
  [GroupType.RADIO]: 'Single Selection',
  [GroupType.DATE]: 'Date',
...
@Component({
  ...
  // imports: [CdkDrag, BuilderField, BuilderDeleteButton, OptionListsFloat, ReactiveFormsModule],
